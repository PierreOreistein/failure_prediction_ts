...
# turbofan_failure_prediction documentation build
...
from turbofan_failure_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "turbofan_failure_prediction"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "turbofan_failure_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "turbofan_failure_prediction.tex",
        "turbofan_failure_prediction Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "turbofan_failure_prediction",
        "Project turbofan_failure_prediction codebase.",
        "Data-Science",
    )
]
